...
For more advanced usage scenarios, check out the [examples](https://github.com/MIheretuTesh) directory.

## License

guard-env is licensed under the MIT License. See the [LICENSE](https://github.com/MIheretuTesh) file for details.
