...
> Warning: In this tutorial, I use old version of `Next.js` and `MDX` library. If you use the latest version, you may need to adjust the code accordingly. Visit [my old personal blog repository](https://github.com/Miheretu) to see the full code.
